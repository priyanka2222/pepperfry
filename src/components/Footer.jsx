                ...
                <div className="row">
                    <div id="blf-col" className="flex-basis50">
                        <ul>
                            ...
                            <li><Link to="">Write A Testimonial</Link></li>
                        </ul>
                    </div>
                    <div id="blf-col"  className="flex-basis50">
                        <ul>
                            <li><Link to=""></Link>Whitehat |&nbsp</li>
                            <li><Link to=""> Site Map |&nbsp</Link></li>
                            <li><Link to="">Terms Of Use |&nbsp</Link></li>
                            <li><Link to="">Privacy Policy |&nbsp</Link></li>
                            <li><Link to="">Your Data & Security |&nbsp</Link></li>
